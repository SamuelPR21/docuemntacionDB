...
SELECT
    p.id_patologia AS id_patologia,
...
SELECT
    ...
    pat.id_patologia AS id_patologia,
...
JOIN modulo9.patologias pat
  ON pat.id_patologia = ps.id_patologia
LEFT JOIN modulo9.especies_patologias ep
  ON ep.id_patologia = pat.id_patologia
LEFT JOIN modulo9.especies e
  ON e.id_especie = ep.id_especie
LEFT JOIN versiones_por_patologia vp
  ON vp.id_patologia = pat.id_patologia
...
JOIN modulo9.patologias pat
  ON pat.id_patologia = pred.id_patologia
