-- ==============================================================
-- SCRIPT DE INSERCIÓN DE DATOS — MÓDULO 9  (versión 2.0)
-- ==============================================================
-- ─────────────────────────────────────────────────────────────
...
-- 2. PATOLOGIAS
-- ─────────────────────────────────────────────────────────────
INSERT INTO modulo9.patologias (nombre, descripcion, es_activo, nombre_tecnico, etiologia, categoria, codigo_cie) VALUES
...
('Vibriosis',
 ...
 'Bacteria gramnegativa del género Vibrio (V. harveyi, V. parahaemolyticus). Oportunista en condiciones de estrés.',
 'bacteriana',
 'B96.82'),
...
('Saprolegniosis',
 ...
 'Oomicetos del género Saprolegnia spp. Oportunista; coloniza tejidos dañados o inmunocomprometidos.',
 'micotica',
 'B48.8'),
...
('Síndrome de la mancha blanca',
 ...
 'Virus de doble cadena de ADN: White Spot Syndrome Virus (WSSV). Se transmite horizontal y verticalmente.',
 'viral',
 'B33.8');
...
-- 4. CICLOS_BIOLOGICOS
-- ─────────────────────────────────────────────────────────────
INSERT INTO modulo9.ciclos_biologicos (nombre, descripcion, duracion_dias, id_especie, es_activo) VALUES
...
VALUES
('IOT-EST01-HLA-001',
 'Nodo IoT principal estanque 01, gateway LoRaWAN con batería solar',
 1, true, NOW()),
('IOT-EST02-HLA-002',
 'Nodo IoT estanque 02, módulo WiFi con fuente de red',
 2, true, NOW()),
('IOT-ALE01-HLA-003',
 'Nodo IoT alevinera, módulo compacto de bajo consumo',
 3, true, NOW()),
('IOT-TRU01-VLC-001',
 'Nodo IoT estanque trucha 01, resistente a bajas temperaturas',
 4, true, NOW()),
('IOT-TRU02-VLC-002',
 'Nodo IoT estanque trucha 02, con alarma local integrada',
 5, true, NOW()),
('IOT-CAM01-COR-001',
 'Nodo IoT piscina camarón 01, gateway LoRaWAN costero',
 6, true, NOW()),
('IOT-CAM02-COR-002',
 'Nodo IoT piscina camarón 02, módulo de respaldo',
 7, true, NOW()),
('IOT-CAC01-CAL-001',
 'Nodo IoT estanque cachama, módulo estándar de campo',
 8, true, NOW()),
('IOT-MOJ01-CAL-002',
 'Nodo IoT estanque mojarra, módulo estándar de campo',
 9, true, NOW());
...
-- Dispositivo 1 — Estanque-01 (El Remanso)
...
-- fecha_aplicacion NULL indica que aún no se ha aplicado.
-- ─────────────────────────────────────────────────────────────
